...
const SOCIALS = [
  { icon: <InstagramIcon/>, label: 'Instagram', href: 'https://www.instagram.com/raymi_fotografia/' },
  { icon: <FacebookIcon/>,  label: 'Facebook',  href: 'https://www.facebook.com/profile.php?id=61586185749548' },
      ...
      <div className={styles.top}>
        <div className={styles.column}>
          ...
          <p className={styles.description}>
            Fotógrafo profesional en Lima. Capturamos la esencia de tus momentos más especiales con foto y video.
          </p>
        </div>
